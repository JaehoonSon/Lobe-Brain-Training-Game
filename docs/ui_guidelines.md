...
- **Avoid Over-Saturation**: Do not make entire page backgrounds Orange or Purple. Use these colors for _objects_ (Cards, Buttons, Pills) on top of the neutral background.
