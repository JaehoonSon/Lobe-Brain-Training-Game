    ...
    <View className="flex-1 bg-background p-4 items-center justify-center">
      <ScrollView className="flex-1">
        <SafeAreaView className="flex-1 items-center justify-center gap-6">
          ...
          >
            <Text className="text-foreground font-bold">Test StoreReview</Text>
          </Button>
          <Button
            className="w-full h-12 px-6"
            onPress={() => StoreReview.resetTracking()}
          >
            <Text className="text-foreground font-bold">Reset StoreReview</Text>
          </Button>
        </SafeAreaView>
      </ScrollView>
    </View>
