    ...
    return (
        <View className="flex-1 bg-background px-6" style={{ paddingTop: insets.top, paddingBottom: insets.bottom + 16 }}>
            ...
            <View className="flex-1 justify-center items-center">
                <Animated.View entering={FadeInDown.duration(600)} className="items-center gap-4 mb-8">
                ...
                <View className="w-full max-w-xs gap-4 mb-8">
                    {goals.map((goal, index) => (
                        ...
                        >
                            ...
                            <Text className="font-bold text-lg text-foreground">{goal.label}</Text>
            ...
            <Animated.View entering={ZoomIn.delay(600).duration(500).springify()} className="w-full">
                <Button
                    size="xl"
                    className="w-full rounded-2xl h-16"
                    onPress={handleBegin}
                >
                    <Text className="font-extrabold text-xl tracking-wide uppercase">Let's Begin</Text>
                </Button>
            </Animated.View>
        </View>
    );
